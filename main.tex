...
Spring 2026 -- Fall 2026 & Leadership Research Faculty Fellow, Rutgers--New Brunswick Office for Research (NB OfR) \\
...
\begin{itemize}
    \item {\bf Best Paper Award (Outstanding Solution Paper)}, ACM Conference on AI and Society (CAIS), 2026. TraceFix: Repairing Agent Coordination Protocols with TLA+ Counterexamples.
    \item Invited speaker at Rutgers Computer Science Colloquium, April 2026: \emph{Toward Trustworthy Agentic Systems for Smart Spaces}
...
\section{Service}
\begin{enumerate}
    \item Reviewer, The Fifteenth International Conference on Learning Representations (ICLR 2027)
    \item Reviewer, IEEE/CVF Winter Conference on Applications of Computer Vision (WACV 2027)
    \item Reviewer, Neural Information Processing Systems (NeurIPS 2026)
    \item Reviewer, ACM SIGKDD Conference on Knowledge Discovery and Data Mining (KDD 2026)
    \item External reviewer, promotion and tenure, Pennsylvania State University (2026)
    \item Reviewer, International Conference on Learning Representations (ICLR 2026)
    \item Reviewer, NeurIPS 2025 Position Paper Track
    \item Reviewer, IEEE/CVF International Conference on Computer Vision (ICCV 2025)
    ...
    \item Reviewer, International Conference on Learning Representations (ICLR 2025)
