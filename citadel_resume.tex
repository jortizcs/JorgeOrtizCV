...
% Page layout
\usepackage[letterpaper, margin=0.6in, top=0.45in, bottom=0.5in]{geometry}
\usepackage{setspace}
\setstretch{0.95}
...
% Custom lists
\setlist[itemize]{leftmargin=12pt, itemsep=0.5pt, parsep=0pt, topsep=1pt}
...
\end{tikzpicture}
\vspace{2pt}
{\fontsize{24}{28}\selectfont\bfseries\color{citadelBlue}JORGE J. ORTIZ, Ph.D.}\\[1pt]
{\Large\color{darkGray}Machine Learning \& AI Research Leader}\\[0.5pt]
{\large\color{mediumGray}Associate Professor, Rutgers \textbullet\ AI \& Computer Vision Lead, New York Yankees}\\[3pt]
...
\textcolor{mediumGray}{University of California, Berkeley} & \\[2pt]
...
\listentry{Build forecasting and representation models for high-variance, adversarial environments; improve model performance through rapid iteration and targeted debugging}
\listentry{Built models robust to regime shifts, outliers, and rare events; improved stability through targeted constraints and failure-mode analysis}
...
\vspace{3pt}
\profentry{Associate Professor}{Sept. 2018 -- Present}{Rutgers University, Electrical and Computer Engineering}{}
\begin{itemize}
\listentry{Lead research group focused on multimodal deep learning, time-series modeling, and large-scale ML infrastructure}
\listentry{Develop sequence models, multimodal architectures, and learning methods for noisy large-scale datasets}
\listentry{Designed and optimized training pipelines enabling rapid experimentation over large-scale multimodal datasets}
\listentry{Published work in NeurIPS and related ML venues with results deployed in real-world systems}
\listentry{Mentor researchers working on multimodal ML and production systems}
\end{itemize}
...
\listentry{Developed forecasting and anomaly detection models for nonstationary, distribution-shifted time-series}
...
\begin{center}
\begin{tikzpicture}
\node[fill=offWhite, rounded corners=8pt, inner sep=7pt, text width=\textwidth-20pt, align=center] {
\textbf{\color{citadelBlue}Adversarial Robustness} \textbullet\ 
\textbf{\color{citadelBlue}Nonstationary Time-Series Modeling} \textbullet\ 
\textbf{\color{citadelBlue}High-Frequency Data Processing}\\[2pt]
\textbf{\color{citadelBlue}Model Debugging \& Failure Mode Analysis} \textbullet\ 
\textbf{\color{citadelBlue}Representation Learning} \textbullet\ 
\textbf{\color{citadelBlue}Sequence Modeling}\\[2pt]
...
\begin{itemize}
\listentry{\textbf{\color{citadelBlue}Production ML Deployment}: Deployed production CV and sequence models used daily in real-time, high-stakes decision workflows}
...
\section{Mentoring}
Mentor Ph.D. researchers working on multimodal ML and production systems.

\vspace{4pt}
\begin{center}
\begin{tikzpicture}
\node[fill=citadelBlue!8, rounded corners=8pt, inner sep=6pt, text width=\textwidth-20pt, align=center] {
\textbf{\color{citadelBlue}Strengths:} Building robust ML systems from noisy data \textbullet\ Fast iteration under uncertainty \textbullet\ Deploying deep learning models in production
};
\end{tikzpicture}
\end{center}
