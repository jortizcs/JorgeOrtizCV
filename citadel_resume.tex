...
\listentry{Built models robust to regime shifts, outliers, and rare-event structure; improved stability through targeted feature constraints and failure-mode analysis}
...
\textbf{\color{citadelBlue}Strengths:} Building robust ML systems from noisy data \textbullet\ Fast iteration under uncertainty \textbullet\ Deploying deep learning models at scale
};
\end{tikzpicture}
\end{center}
