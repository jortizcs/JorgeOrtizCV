...
Tenured Associate Professor and Machine Learning/AI research leader with proven track record deploying production ML systems at scale. Currently AI \& Computer Vision Lead for New York Yankees Baseball Operations, applying advanced ML/computer vision to optimize performance and gain competitive advantage through data-driven insights. Ph.D. from UC Berkeley with 12+ years bridging cutting-edge research and real-world applications. Principal Investigator on \$32.4M research portfolio delivering measurable outcomes across autonomous systems, computer vision, time-series forecasting, and multimodal learning. Published 40+ peer-reviewed papers with multiple best paper awards including NeurIPS 2025. Strong quantitative foundation (MIT, UC Berkeley), exceptional technical depth, and demonstrated ability to lead cross-functional teams solving complex problems in high-stakes environments.
};
\end{tikzpicture}
\end{center}
...
\begin{itemize}
\listentry{\textbf{\color{citadelBlue}Tenure Achievement}: Awarded tenure at Rutgers University (2025) recognizing sustained excellence in research, leadership of \$32.4M portfolio, and demonstrated impact across ML/AI systems}
